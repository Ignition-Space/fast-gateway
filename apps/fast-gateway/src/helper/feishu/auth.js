...
var getUserToken = function (_a) {
    var code = _a.code, app_token = _a.app_token;
 ...
 */
var refreshUserToken = function (_a) {
    var refreshToken = _a.refreshToken, app_token = _a.app_token;
    return __awaiter(void 0, void 0, void 0, function () {
        var data;
        return __generator(this, function (_b) {
            switch (_b.label) {
...
var getUserAccessToken = function (code) { return __awaiter(void 0, void 0, void 0, function () {
    var data;
